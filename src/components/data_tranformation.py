...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            #since dataset has only numerical features
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            X_train=train_df.drop(columns=['concrete_compressive_strength'],axis=1)
            y_train=train_df['concrete_compressive_strength']

            X_test=test_df.drop(columns=['concrete_compressive_strength'],axis=1)
            y_test=test_df['concrete_compressive_strength']
